...
/**
 * 표 상단 검색 필드. `value`/`onChange` 에 TanStack Table 의
 * `globalFilter`·`setGlobalFilter` 를 그대로 꽂는다.
 */
export const Default = () => {
  const [filter, setFilter] = useState("");
  return <Search value={filter} onChange={setFilter} placeholder="의뢰기관, 주소 검색 ..." />;
};
