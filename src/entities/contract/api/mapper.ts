import { toDateKey, trimValue } from '@shared/lib';
...
export const toRegisterRequest = (vo: ContractCreate): ContractRegisterRequest => ({
  ...
  contractDate: toDateKey(vo.contractDate),
  startDate: toDateKey(vo.startDate),
  completionDate: toDateKey(vo.completionDate),
