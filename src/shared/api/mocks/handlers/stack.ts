...
const stacksByWorkplace: Record<number, StackRow[]> = {
  ...
  106: [
    ...
    { id: 1008, companyName: '동아화학공업',      workplaceName: '동아화학공업 부산본사',       field: 'WATER',           stackName: '1호 배출구',    createdAt: '2024-05-12', modifiedAt: '2025-08-22' },
    { id: 1009, companyName: '동아화학공업',      workplaceName: '동아화학공업 부산본사',       field: 'WATER',           stackName: '2호 배출구',    createdAt: '2024-06-30', modifiedAt: '2026-02-14' },
  ],
  107: [
    { id: 1010, companyName: '동아화학공업',      workplaceName: '동아화학공업 창원공장',       field: 'WATER',           stackName: '1호 배출구',    createdAt: '2023-11-01', modifiedAt: '2025-07-18' },
    { id: 1011, companyName: '동아화학공업',      workplaceName: '동아화학공업 창원공장',       field: 'WATER',           stackName: '2호 배출구',    createdAt: '2023-11-01', modifiedAt: '2025-07-18' },
    { id: 1012, companyName: '동아화학공업',      workplaceName: '동아화학공업 창원공장',       field: 'AIR',             stackName: '1호 굴뚝',      createdAt: '2024-03-05', modifiedAt: '2025-11-30' },
    { id: 1013, companyName: '동아화학공업',      workplaceName: '동아화학공업 창원공장',       field: 'AIR',             stackName: '2호 굴뚝',      createdAt: '2024-03-05', modifiedAt: '2026-01-08' },
  ],
  108: [
    { id: 1014, companyName: '동아화학공업',      workplaceName: '동아화학공업 거제사업장',     field: 'WATER',           stackName: '1호 배출구',    createdAt: '2025-02-17', modifiedAt: '2025-12-03' },
    { id: 1015, companyName: '동아화학공업',      workplaceName: '동아화학공업 거제사업장',     field: 'WATER',           stackName: '2호 배출구',    createdAt: '2025-02-17', modifiedAt: '2026-03-20' },
  ],
  109: [
    { id: 1016, companyName: '(주)그린에너지',    workplaceName: '(주)그린에너지 대전본사',     field: 'ODOR',            stackName: '악취 측정지점 1', createdAt: '2024-09-09', modifiedAt: '2025-10-25' },
    { id: 1017, companyName: '(주)그린에너지',    workplaceName: '(주)그린에너지 대전본사',     field: 'ODOR',            stackName: '악취 측정지점 2', createdAt: '2024-09-09', modifiedAt: '2026-02-01' },
  ],
  110: [
    { id: 1018, companyName: '(주)그린에너지',    workplaceName: '(주)그린에너지 세종사업장',   field: 'ODOR',            stackName: '악취 측정지점 1', createdAt: '2025-04-22', modifiedAt: '2025-12-11' },
  ],
  111: [
    { id: 1019, companyName: '삼진제조(주)',       workplaceName: '삼진제조(주) 대구본사',       field: 'NOISE_VIBRATION', stackName: '측정지점 1',    createdAt: '2024-02-14', modifiedAt: '2025-09-16' },
    { id: 1020, companyName: '삼진제조(주)',       workplaceName: '삼진제조(주) 대구본사',       field: 'NOISE_VIBRATION', stackName: '측정지점 2',    createdAt: '2024-02-14', modifiedAt: '2025-09-16' },
  ],
  112: [
    ...
    { id: 1023, companyName: '삼진제조(주)',       workplaceName: '삼진제조(주) 구미공장',       field: 'NOISE_VIBRATION', stackName: '측정지점 1',    createdAt: '2024-01-10', modifiedAt: '2026-01-15' },
  ],
  113: [
    { id: 1024, companyName: '삼진제조(주)',       workplaceName: '삼진제조(주) 포항사업장',     field: 'NOISE_VIBRATION', stackName: '측정지점 1',    createdAt: '2024-11-05', modifiedAt: '2026-03-01' },
    { id: 1025, companyName: '삼진제조(주)',       workplaceName: '삼진제조(주) 포항사업장',     field: 'AIR',             stackName: '1호 굴뚝',      createdAt: '2024-11-05', modifiedAt: '2026-03-01' },
  ],
  114: [
  ...
  119: [
    ...
    { id: 1038, companyName: '세진중공업(주)',      workplaceName: '세진중공업(주) 창원본사',     field: 'NOISE_VIBRATION', stackName: '측정지점 1',    createdAt: '2024-07-15', modifiedAt: '2026-01-06' },
    { id: 1039, companyName: '세진중공업(주)',      workplaceName: '세진중공업(주) 창원본사',     field: 'NOISE_VIBRATION', stackName: '측정지점 2',    createdAt: '2024-07-15', modifiedAt: '2026-01-06' },
  ],
  120: [
    ...
    { id: 1041, companyName: '세진중공업(주)',      workplaceName: '세진중공업(주) 거제조선소',   field: 'WATER',           stackName: '1호 배출구',    createdAt: '2023-09-25', modifiedAt: '2025-07-07' },
  ],
  121: [
  ...
  124: [
    ...
    { id: 1049, companyName: '경남산업(주)',         workplaceName: '경남산업(주) 김해공장',       field: 'WATER',           stackName: '1호 배출구',    createdAt: '2023-10-20', modifiedAt: '2026-03-15' },
  ],
  125: [
