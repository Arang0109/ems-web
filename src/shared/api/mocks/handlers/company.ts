...
export const companyHandlers = [
  http.get(`${BASE_URL}/companies`, () => {
    return HttpResponse.json({
      ...
      data: [
        { id: 1,  name: '(주)한국환경기술', ceoName: '가나다',  address: '서울특별시 강남구 테헤란로 123',          bizNumber: '238-32482-34' },
        { id: 2,  name: '대성산업(주)',      ceoName: '박철호',  address: '경기도 수원시 영통구 월드컵로 206',        bizNumber: '401-29384-55' },
        { id: 3,  name: '동아화학공업',      ceoName: '정성훈',  address: '부산광역시 사하구 하신중앙로 99',          bizNumber: '611-47832-43' },
        { id: 4,  name: '(주)그린에너지',    ceoName: '임수진',  address: '대전광역시 유성구 대덕대로 512',           bizNumber: '803-72918-54' },
        { id: 5, name: '삼진제조(주)',       ceoName: '오태현',  address: '대구광역시 달서구 성서산업로 100',         bizNumber: '104-93847-62' },
        { id: 6, name: '한빛소재산업',       ceoName: '유준서',  address: '광주광역시 광산구 하남산단 6번로 107',     bizNumber: '126-61573-28' },
        { id: 7, name: '(주)미래환경',       ceoName: '남기훈',  address: '인천광역시 남동구 남동공단로 215',         bizNumber: '137-43829-16' },
        { id: 8, name: '세진중공업(주)',      ceoName: '조현우',  address: '경상남도 창원시 성산구 공단로 730',        bizNumber: '159-38274-61' },
        { id: 9, name: '(주)태양기술',        ceoName: '황성진',  address: '서울특별시 마포구 월드컵북로 396',         bizNumber: '173-58291-34' },
        { id: 10, name: '경남산업(주)',         ceoName: '홍길동',  address: '부산광역시 강서구 신항대로 345',           bizNumber: '184-73618-52' },
        { id: 11, name: '현대에너지(주)',       ceoName: '안준혁',  address: '울산광역시 남구 삼산로 100',               bizNumber: '195-46827-93' },
        { id: 12, name: '(주)청정환경',         ceoName: '송미경',  address: '경기도 성남시 분당구 판교로 256',          bizNumber: '207-85136-74' },
      ],
    });
  }),
