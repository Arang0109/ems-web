import { useUpdateTeam } from "../model/hooks/use-update-team";
import { useDeleteTeam } from "../model/hooks/use-delete-team";
...
export const UpdateTeamForm = ({ open, onOpenChange, team, onSuccess }: Props) => {
  const {
    form,
    fieldErrors,
    memberOptions,
