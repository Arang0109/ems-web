...
import { GAS_ANALYZER_DURATION_MINUTES, THC_ANALYZER_DURATION_MINUTES } from "../derived/derived-times";
...
export const EXHAUST_GAS_HINT = {
  gasAnalyzer: `가스분석기 측정 시작 시각입니다.\n측정 시간은 ${GAS_ANALYZER_DURATION_MINUTES}분으로 설정됩니다.`,
  thcAnalyzer: `THC 측정 시작 시각입니다.\n측정 시간은 ${THC_ANALYZER_DURATION_MINUTES}분으로 설정됩니다.`,
  standardOxygen:
    "측정시설에 등록된 표준산소농도입니다.",
  o2CorrectionFactor:
...
export const PARTICLE_HINT = {
  ...
  recommendationHelp:
  "희망 흡입량(표준상태)을 확보하기 위해 필요한 최소 채취 시간과 예상 채취량을 안내합니다. 실제 채취량은 채취 중 흡입 유량, 온도, 압력 등의 변화에 따라 달라질 수 있어 희망 흡입량과 차이가 발생할 수 있습니다.",
