...
import type { SamplingRecordTemplate } from "../model/hooks/use-sampling-record-template";
...
// 채취기록지 다운로드 — 관리자가 등록해 둔 채취기록부 양식(문서 + 버전)을 고르면
...
export const ExportSamplingRecordsModal = ({
  ...
  return (
    <FormDialog
      title="채취기록지 다운로드"
      description="등록된 채취기록부 양식을 선택하면 현재 측정 데이터를 저장한 뒤 채취기록지를 내려받습니다."
      open={open}
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <Select
          id="sampling-record-template-version"
          label="버전"
          required
