...
import { useRegisterStackMeasurement } from "../model/hooks/use-register-stack-measurement";
...
export const RegisterStackMeasurementForm = ({
  stackId,
  open,
  onOpenChange,
  onSuccess,
  ...
  const { form, handleChange, handleSubmit } = useRegisterStackMeasurement({
    stackId,
    onSuccess: () => {
      onOpenChange(false);
      onSuccess?.();
